...
function getAll($table)
{
    ...
    if(isset($_POST['add_product_btn']))
    {
        ...
        $ships_from = $_POST['ships_from']; // Update variable name
        $ships_to = $_POST['ships_to']; // Update variable name
        $name = $_POST['name'];
        $slug = $_POST['slug'];
        ...
        if($name != "" && $slug != "" && $description != "")
        {
            ...
            qty, vendor_name, meta_title, meta_keywords, status, trending, image, ships_from, ships_to) VALUES 
            ('$category_id', '$name', '$slug', '$small_description', '$description', '$original_price', '$selling_price', '$qty', '$vendor_name', '$meta_title', '$meta_keywords', '$status', '$trending', '$filename', '$ships_from', '$ships_to')";
