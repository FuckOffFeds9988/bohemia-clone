...
if(isset($_POST['update_product_btn']))
{
    ...
    $update_product_query = "UPDATE products SET category_id='$category_id',category_name='$category_name',name='$name',slug='$slug',small_description='$small_description',description='$description',original_price='$original_price',selling_price='$selling_price',qty='$qty',vendor_name='$vendor_name',meta_title='$meta_title',
    ...
    <div class="row">
       <div class="col-md-12">
           <?php 
            ...
            <!-- Add a hidden input for category_name -->
            <input type="hidden" name="category_name" value="<?= $data['category_name']; ?>">
                                                ...
                                                <input type="text" name="vendor_name" value="<?= $data['vendor_name'] ?>" placeholder="Enter vendor name" class="form-control">
                                            </div>
                                                <div class="col-md-6">
