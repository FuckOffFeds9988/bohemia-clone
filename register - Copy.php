...
">
    ...
    font-size: 14px;
    margin-top: 10px;
    text-align: center;" type="text" name="username" placeholder="Username" id="Username" value="" required>
    ...
    font-size: 14px;
    margin-top: 10px;
    text-align: center;" type="password" name="userPassword" placeholder="Password" id="userPassword" value="" required>
                <ul style="list-style-type: none;  ">
                  <li>
    ...
    font-size: 14px;
    margin-top: 10px;
    text-align: center;" type="password" name="confirmPassword" placeholder="Confirm Password" id="password" value="" required>
                <ul style="list-style-type: none;  ">
                  <li>
    ...
    font-size: 14px;
    margin-top: 10px;
    text-align: center;" type="text" name="pin" placeholder="4 character pin" id="pin" value="" required>
                <ul style="list-style-type: none;  ">
                  <li>
    ...
    position: absolute;">Login</button></a>
            ...
            <a href="login.php"><button type="button" name="back" id="back_btn" style=" padding: 10px 25px 8px;
    margin-left: 67px;
    position: absolute;
    color: #fff;
    background-color: #0067ab;
    ...
    cursor: pointer;
    display: inline-block;
    position: absolute;">Back</button></a>
      </form>
    </div>
